...
\portada{Lab-MR 1-II}{Seguimiento de trayectorias impl\'{i}citas}%
...
El sistema se compone de un \'{u}nico nodo \ros{} que se comunica con \coppelia{} mediante tres topics. La Tabla~\ref{tab:nodos} resume la arquitectura.
...
Los par\'{a}metros se cargan desde \texttt{corr\_params.yaml}. La Tabla~\ref{tab:parametros} recoge los valores finales.
...
La Tabla~\ref{tab:velocidades} resume las velocidades comandadas en cada modo.
