...
\paragraph{Cambio de waypoint a $\SI{1}{\meter}$.} El waypoint se considera alcanzado cuando la distancia eucl\'{i}dea al punto objetivo es inferior a $\SI{1}{\meter}$:
\begin{equation*}
  \sqrt{(x_P - x)^2 + (y_P - y)^2} < \SI{1}{\meter},
\end{equation*}
